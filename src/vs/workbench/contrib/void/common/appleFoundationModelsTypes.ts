...
/** model ids Loophole will actually try to chat-complete against for this provider; excludes embedding-only ids like `apple-nl-contextual-en` that `afm`/`fm` also list in /v1/models */
