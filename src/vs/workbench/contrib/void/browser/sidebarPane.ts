...
// const voidViewIcon = registerIcon('void-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the Loophole chat view.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "Loophole" (Ctrl + L)
