...
Kodia separately records basic usage like the number of messages people are sending. If you'd like to disable Kodia metrics, you may do so in Kodia's Settings.
`;
